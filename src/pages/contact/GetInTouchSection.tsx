...
export const GetInTouchSection = () => {
  return (
    <section className="border-GrayishDarkBlue/15 flex flex-col gap-[24px] border-y pt-[25px] pb-[32px]">
      <h1 className="text-GrayishDarkBlue text-[40px] leading-[42px] font-bold tracking-[-0.36px]">
        Get in Touch
      </h1>
